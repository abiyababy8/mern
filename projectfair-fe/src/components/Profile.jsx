      ...
      <div className='shadow p-4'>
        <div className='d-flex mt-3'>
          ...
          <div className='ms-auto'>
            <button className='btn btn-primary' onClick={() => setOpen(!open)}><i class="fa-solid fa-angle-up"></i></button>
          </div>
        </div>
        <Collapse in={open}>
          <div>
