...
function Footer() {
  return (
    <>
      ...
      <div className='d-flex justify-content-center align-items-center bg-primary row'>
        <div className='d-flex justify-content-center align-items-evenly'>
          <div className='overview mt-1 col-md-3' style={{ width: '400px' }}>
          ...
          <div className='links d-flex flex-column ms-5 mt-1 col-md-1' style={{ color: 'white' }}>
          ...
          <div className='contact_us ms-5 mt-1 col-md-3' style={{ color: 'white' }}>
